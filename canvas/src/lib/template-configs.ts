...
const t4FluidAd: SlotSchema = {
  ...
  fields: [
    ...
    {
      type: 'text',
      sel: '.features .feature-item:nth-child(1) .feature-name',
    ...
    {
      type: 'text',
      sel: '.features .feature-item:nth-child(1) .feature-label',
    ...
    {
      type: 'text',
      sel: '.features .feature-item:nth-child(2) .feature-name',
    ...
    {
      type: 'text',
      sel: '.features .feature-item:nth-child(2) .feature-label',
    ...
    {
      type: 'text',
      sel: '.features .feature-item:nth-child(3) .feature-name',
    ...
    {
      type: 'text',
      sel: '.features .feature-item:nth-child(3) .feature-label',
    ...
    {
      type: 'text',
      sel: '.features .feature-item:nth-child(4) .feature-name',
    ...
    {
      type: 'text',
      sel: '.features .feature-item:nth-child(4) .feature-label',
...
const t7Carousel: SlotSchema = {
  ...
  fields: [
    ...
    {
      type: 'text',
      sel: '[data-slide="1"] .slide-counter',
      label: 'Counter · slide 1',
      mode: 'text',
      rows: 1,
    },
    {
      type: 'text',
      sel: '[data-slide="1"] .slide-label span',
      label: 'Side label · slide 1',
      mode: 'text',
      rows: 1,
    },
    ...
    {
      type: 'text',
      sel: '[data-slide="2"] .slide-counter',
      label: 'Counter · slide 2',
      mode: 'text',
      rows: 1,
    },
    {
      type: 'text',
      sel: '[data-slide="2"] .slide-label span',
      label: 'Side label · slide 2',
      mode: 'text',
      rows: 1,
    },
    ...
    {
      type: 'text',
      sel: '[data-slide="3"] .slide-counter',
      label: 'Counter · slide 3',
      mode: 'text',
      rows: 1,
    },
    {
      type: 'text',
      sel: '[data-slide="3"] .slide-label span',
      label: 'Side label · slide 3',
      mode: 'text',
      rows: 1,
    },
    {
      type: 'text',
      sel: '[data-slide="3"] .s3-tool-name',
      label: 'Tool Name',
      mode: 'text',
      rows: 1,
    },
    ...
    {
      type: 'text',
      sel: '[data-slide="3"] .s3-difficulty-value',
      label: 'Difficulty',
      mode: 'text',
      rows: 1,
    },
    {
      type: 'image',
      sel: '[data-slide="3"] .s3-screenshot img',
      label: 'Screenshot',
      dims: '852 × 399px',
    },
    /* Slide 4 */
    ...
    {
      type: 'text',
      sel: '[data-slide="4"] .slide-counter',
      label: 'Counter · slide 4',
      mode: 'text',
      rows: 1,
    },
    {
      type: 'text',
      sel: '[data-slide="4"] .slide-label span',
      label: 'Side label · slide 4',
      mode: 'text',
      rows: 1,
    },
    {
      type: 'text',
      sel: '[data-slide="4"] .s4-feature-name',
      label: 'Feature Name',
      mode: 'text',
      rows: 1,
    },
...
const t8QuarterlyStats: SlotSchema = {
  ...
  fields: [
    ...
    {
      type: 'text',
      sel: '[data-slide="1"] .s1-eyebrow',
      label: 'Eyebrow (e.g. Fluid · Q1 2026)',
      mode: 'text',
      rows: 1,
    },
    {
      type: 'text',
      sel: '[data-slide="1"] .s1-quarter',
      label: 'Quarter (e.g. Q1)',
      mode: 'text',
      rows: 1,
    },
    ...
    {
      type: 'text',
      sel: '[data-slide="1"] .s1-hero-num',
      label: 'Hero Stat (e.g. +34%)',
      mode: 'text',
      rows: 1,
    },
    {
      type: 'text',
      sel: '[data-slide="1"] .s1-hero-label',
      label: 'Hero Label',
      mode: 'text',
      rows: 1,
    },
    ...
    {
      type: 'text',
      sel: '[data-slide="2"] .s2-col-1 .s2-num',
      label: 'Stat 1 Number',
      mode: 'text',
      rows: 1,
    },
    {
      type: 'text',
      sel: '[data-slide="2"] .s2-col-1 .s2-lbl',
      label: 'Stat 1 Label',
      mode: 'text',
      rows: 1,
    },
    {
      type: 'text',
      sel: '[data-slide="2"] .s2-col-2 .s2-num',
      label: 'Stat 2 Number',
      mode: 'text',
      rows: 1,
    },
    {
      type: 'text',
      sel: '[data-slide="2"] .s2-col-2 .s2-lbl',
      label: 'Stat 2 Label',
      mode: 'text',
      rows: 1,
    },
    {
      type: 'text',
      sel: '[data-slide="2"] .s2-col-3 .s2-num',
      label: 'Stat 3 Number',
      mode: 'text',
      rows: 1,
    },
    {
      type: 'text',
      sel: '[data-slide="2"] .s2-col-3 .s2-lbl',
      label: 'Stat 3 Label',
      mode: 'text',
      rows: 1,
    },
    ...
    {
      type: 'text',
      sel: '[data-slide="4"] .s4-eyebrow',
      label: "Eyebrow (e.g. What's Next)",
      mode: 'text',
      rows: 1,
    },
    ...
    {
      type: 'text',
      sel: '[data-slide="4"] .s4-mini-1 .s4-mini-num',
      label: 'Mini Stat 1 Number',
      mode: 'text',
      rows: 1,
    },
    {
      type: 'text',
      sel: '[data-slide="4"] .s4-mini-1 .s4-mini-lbl',
    ...
    {
      type: 'text',
      sel: '[data-slide="4"] .s4-mini-2 .s4-mini-num',
      label: 'Mini Stat 2 Number',
      mode: 'text',
      rows: 1,
    },
    {
      type: 'text',
      sel: '[data-slide="4"] .s4-mini-2 .s4-mini-lbl',
    ...
    {
      type: 'text',
      sel: '[data-slide="4"] .s4-mini-3 .s4-mini-num',
      label: 'Mini Stat 3 Number',
      mode: 'text',
      rows: 1,
    },
    {
      type: 'text',
      sel: '[data-slide="4"] .s4-mini-3 .s4-mini-lbl',
...
export const TEMPLATE_METADATA: TemplateMetadata[] = [
  ...
  },
  {
    ...
    description:
      '4-slide carousel: cover, intro text, tool feature, app feature. Movable counter, side label, and arrow on slide 2.',
...
export function resolveSlotSchemaForIteration(
  ...
  const tid =
    ...
    inferTemplateIdFromHtmlPath(htmlPath ?? undefined) ||
    '';
  ...
  if (isUsableStoredSlotSchema(stored)) {
    ...
    if (canonical && canonical.templateId === tid) {
      return {
        ...
        brushAdditional:
          canonical.brushAdditional !== undefined
            ? canonical.brushAdditional
            : stored.brushAdditional,
        carouselCount:
