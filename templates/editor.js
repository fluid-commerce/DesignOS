...
var TEMPLATES = {
  ...
  't2-app-highlight': {
    ...
    file: 'social/t2-app-highlight.html',
    w: 1080, h: 1080,
    fields: [
  ...
  't3-partner-alert': {
    ...
    file: 'social/t3-partner-alert.html',
    w: 1340, h: 630,
    fields: [
      { type: 'text',  sel: '.headline',       label: 'Headline',     mode: 'text', rows: 2 },
  ...
  't5-partner-announcement': {
    ...
    file: 'social/t5-partner-announcement.html',
    w: 1340, h: 630,
    fields: [
  ...
  't6-employee-spotlight': {
    ...
    file: 'social/t6-employee-spotlight.html',
    w: 1080, h: 1080,
    fields: [
      { type: 'text',  sel: '.headline',       label: 'Headline',        mode: 'br',   rows: 3 },
      { type: 'text',  sel: '.category span',  label: 'Side label',      mode: 'text', rows: 1 },
  ...
  't8-quarterly-stats': {
    ...
    file: 'social/t8-quarterly-stats.html',
    w: 1080, h: 1080,
    carousel: 4,
    fields: [
      /* ── Slide 1 ── */
...
var TEXTURE_CATEGORIES = [
  {
    category: 'Circles',
    items: [
      { id: 'circle-sketch-blue', label: 'Circle sketch (blue)', path: '/fluid-assets/circles/circle-sketch-blue.png' },
      { id: 'circle-001', label: 'Circle 001', path: '/fluid-assets/circles/circle-001.png' },
      { id: 'circle-002', label: 'Circle 002', path: '/fluid-assets/circles/circle-002.png' },
      { id: 'circle-003', label: 'Circle 003', path: '/fluid-assets/circles/circle-003.png' },
      { id: 'circle-004', label: 'Circle 004', path: '/fluid-assets/circles/circle-004.png' },
      { id: 'circle-005', label: 'Circle 005', path: '/fluid-assets/circles/circle-005.png' },
      { id: 'circle-006', label: 'Circle 006', path: '/fluid-assets/circles/circle-006.png' },
      { id: 'circle-007', label: 'Circle 007', path: '/fluid-assets/circles/circle-007.png' },
      { id: 'circle-008', label: 'Circle 008', path: '/fluid-assets/circles/circle-008.png' },
      { id: 'circle-009', label: 'Circle 009', path: '/fluid-assets/circles/circle-009.png' },
      { id: 'circle-010', label: 'Circle 010', path: '/fluid-assets/circles/circle-010.png' },
      { id: 'circle-011', label: 'Circle 011', path: '/fluid-assets/circles/circle-011.png' }
    ]
  },
  {
    category: 'Brush',
    items: [
      { id: 'brush-01', label: 'Brush 01', path: '/fluid-assets/brushstrokes/brush-texture-01.png' },
      { id: 'brush-02', label: 'Brush 02', path: '/fluid-assets/brushstrokes/brush-texture-02.png' },
      { id: 'brush-03', label: 'Brush 03', path: '/fluid-assets/brushstrokes/brush-texture-03.png' },
      { id: 'brush-04', label: 'Brush 04', path: '/fluid-assets/brushstrokes/brush-texture-04.png' },
      { id: 'brush-05', label: 'Brush 05', path: '/fluid-assets/brushstrokes/brush-texture-05.png' },
      { id: 'brush-06', label: 'Brush 06', path: '/fluid-assets/brushstrokes/brush-texture-06.png' },
      { id: 'brush-07', label: 'Brush 07', path: '/fluid-assets/brushstrokes/brush-texture-07.png' },
      { id: 'brush-08', label: 'Brush 08', path: '/fluid-assets/brushstrokes/brush-texture-08.png' },
      { id: 'brush-09', label: 'Brush 09', path: '/fluid-assets/brushstrokes/brush-texture-09.png' },
      { id: 'brush-10', label: 'Brush 10', path: '/fluid-assets/brushstrokes/brush-texture-10.png' }
    ]
  },
  {
    category: 'X',
    items: [
      { id: 'x-199', label: '199', path: '/fluid-assets/xs/199.png' },
      { id: 'x-218', label: '218', path: '/fluid-assets/xs/218.png' },
      { id: 'x-coss-004', label: 'Coss 004', path: '/fluid-assets/xs/Coss_004.png' },
      { id: 'x-coss-007', label: 'Coss 007', path: '/fluid-assets/xs/Coss_007.png' },
      { id: 'x-coss-014', label: 'Coss 014', path: '/fluid-assets/xs/Coss_014.png' }
    ]
  },
  {
    category: 'Scribble',
    items: [
      { id: 'scribble-017', label: 'Scribble 017', path: '/fluid-assets/scribbles/scribble-017.png' },
      { id: 'scribble-023', label: 'Scribble 023', path: '/fluid-assets/scribbles/scribble-023.png' },
      { id: 'scribble-062', label: 'Scribble 062', path: '/fluid-assets/scribbles/scribble-062.png' },
      { id: 'scribble-063', label: 'Scribble 063', path: '/fluid-assets/scribbles/scribble-063.png' },
      { id: 'scribble-064', label: 'Scribble 064', path: '/fluid-assets/scribbles/scribble-064.png' },
      { id: 'scribble-072', label: 'Scribble 072', path: '/fluid-assets/scribbles/scribble-072.png' },
      { id: 'scribble-104', label: 'Scribble 104', path: '/fluid-assets/scribbles/scribble-104.png' },
      { id: 'scribble-117', label: 'Scribble 117', path: '/fluid-assets/scribbles/scribble-117.png' },
      { id: 'scribble-163', label: 'Scribble 163', path: '/fluid-assets/scribbles/scribble-163.png' },
      { id: 'scribble-224', label: 'Scribble 224', path: '/fluid-assets/scribbles/scribble-224.png' },
      { id: 'scribble-228', label: 'Scribble 228', path: '/fluid-assets/scribbles/scribble-228.png' },
      { id: 'scribble-313', label: 'Scribble 313', path: '/fluid-assets/scribbles/scribble-313.png' },
      { id: 'scribble-344', label: 'Scribble 344', path: '/fluid-assets/scribbles/scribble-344.png' },
      { id: 'scribble-405', label: 'Scribble 405', path: '/fluid-assets/scribbles/scribble-405.png' },
      { id: 'scribble-409', label: 'Scribble 409', path: '/fluid-assets/scribbles/scribble-409.png' },
      { id: 'scribble-438', label: 'Scribble 438', path: '/fluid-assets/scribbles/scribble-438.png' },
      { id: 'scribble-482', label: 'Scribble 482', path: '/fluid-assets/scribbles/scribble-482.png' },
      { id: 'scribble-498', label: 'Scribble 498', path: '/fluid-assets/scribbles/scribble-498.png' },
      { id: 'scribble-499', label: 'Scribble 499', path: '/fluid-assets/scribbles/scribble-499.png' }
    ]
  },
  {
    category: 'Lines',
    items: [
      { id: 'line-004', label: 'Line 004', path: '/fluid-assets/lines/Line-004.png' },
      { id: 'line-036', label: 'Line 036', path: '/fluid-assets/lines/Line-036.png' },
      { id: 'line-046', label: 'Line 046', path: '/fluid-assets/lines/Line-046.png' },
      { id: 'line-049', label: 'Line 049', path: '/fluid-assets/lines/line-049.png' },
      { id: 'line-056', label: 'Line 056', path: '/fluid-assets/lines/line-056.png' },
      { id: 'line-059', label: 'Line 059', path: '/fluid-assets/lines/line-059.png' },
      { id: 'line-060', label: 'Line 060', path: '/fluid-assets/lines/line-060.png' },
      { id: 'line-061', label: 'Line 061', path: '/fluid-assets/lines/line-061.png' },
      { id: 'line-062', label: 'Line 062', path: '/fluid-assets/lines/line-062.png' },
      { id: 'line-067', label: 'Line 067', path: '/fluid-assets/lines/line-067.png' },
      { id: 'line-069', label: 'Line 069', path: '/fluid-assets/lines/line-069.png' },
      { id: 'line-072', label: 'Line 072', path: '/fluid-assets/lines/line-072.png' },
      { id: 'line-074', label: 'Line 074', path: '/fluid-assets/lines/line-074.png' },
      { id: 'line-077', label: 'Line 077', path: '/fluid-assets/lines/line-077.png' },
      { id: 'line-087', label: 'Line 087', path: '/fluid-assets/lines/line-087.png' },
      { id: 'line-167', label: 'Line 167', path: '/fluid-assets/lines/line-167.png' },
      { id: 'line-170', label: 'Line 170', path: '/fluid-assets/lines/line-170.png' },
      { id: 'line-173', label: 'Line 173', path: '/fluid-assets/lines/line-173.png' },
      { id: 'line-204', label: 'Line 204', path: '/fluid-assets/lines/line-204.png' },
      { id: 'line-233', label: 'Line 233', path: '/fluid-assets/lines/line-233.png' },
      { id: 'line-238', label: 'Line 238', path: '/fluid-assets/lines/line-238.png' },
      { id: 'line-288', label: 'Line 288', path: '/fluid-assets/lines/line-288.png' }
    ]
  }
];
